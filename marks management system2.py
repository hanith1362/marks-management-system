...
def smail(x,y,z):
    ...
    server.starttls()
    server.login(f,'RockyRocky222')
    server.sendmail(f,t,text)
    server.close()

print('Welcome to Marks Management System')
wb=xlrd.open_workbook('C:/Users/hanith/Downloads/Marks1.xls')
...
while(1):
    ...
    if(s==1):
        ...
        for sname in snames:
            ...
            smail('graph.png',sheet1.cell_value(m,1),' Result Reports of your Son/Daughter')
            plt.close()
            print('sent')
